...
export default function MyCards() {
    const { loading, setLoader, user, snackbar, navigate, searchWord } = useContext(GeneralContext);
        ...
        <div className='Cards'>
            <Typography variant="h1" component="h1" sx={{ fontFamily: "Pacifico, cursive", fontWeight: 600, fontSize: 48, margin: "30px 0 20px 0", paddingBottom: "10px", textAlign: 'center' }}>
                ...
                <Typography component="p" sx={{ fontWeight: 600, fontSize: 16 }}>
                    <br />
                    {!loading && cards.length ? 'Here you can find your cards' : <Link style={{ textDecoration: 'none', color: 'black' }} to={'/business/cards/new'}>You currently have no cards, click <u>here</u> to add your first card!</Link>}
                </Typography>
            </Typography>
            <div className='row'>
