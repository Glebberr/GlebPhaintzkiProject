...
export default function FavoriteCards() {
    ...
    const { setLoader, snackbar, navigate, searchWord } = useContext(GeneralContext);
        ...
        <div className='Cards'>
            <Typography variant="h1" component="h1" sx={{ fontFamily: "Pacifico, cursive", fontWeight: 600, fontSize: 48, margin: "30px 0 20px 0", paddingBottom: "10px", textAlign: 'center' }}>
                ...
                <Typography component="p" sx={{ fontWeight: 600, fontSize: 16 }}>
                    <br />
                    {favoriteCards.length ? "Here you can find your favorite recipes" : "You currently have no favorite cards, Favorite cards will appear here once you've added them to favorites"}
                </Typography>
            </Typography>
            <div className='row'>
                {
